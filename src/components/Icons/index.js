...
export const MenuIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const HelpIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const BackdIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const UserdIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const MucsicIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LikeWhiteIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const CommenIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <defs>
            ...
            >
                <stop></stop>
                <stop offset="1" stoprpacity="0.01"></stop>
            </linearGradient>
        </defs>
    </svg>
);
...
export const SoundIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
